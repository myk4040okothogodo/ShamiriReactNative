  ...
  return (
    <View style={styles.container}>
        ...
        <View style={{ marginLeft:20, marginTop:10}}>
          <Text style={{...title, color:" #33ffdd"}}>Log-In</Text>
        </View>
        ...
        <View style={{marginTop:20}}>
         ...
         <View style={{marginHorizontal:29, marginTop:36, marginBottom:15}}>
           <Button 
             title="SIGN IN"
             buttonStyle= {{...parameters.styledButton, backgroundColor:"#33ffdd"}}
         ...
         <View style={{flexDirection:"row", justifyContent: "flex-end", marginRight:15, marginTop: 50}}>
           ...
           <View>
             <Button  
               ...
               buttonStyle={{...styles.createButton, backgroundColor:"#33ffdd"}}
